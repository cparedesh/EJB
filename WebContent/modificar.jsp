    	...
    	<div class="row">
    		<div class="col s6 offset-s3">
    			<div class="card-panel">
    				<h4 class="center-align">Modificar</h4>
    				<form action="control.do" method="post">
    					<div class="row">
							...
							<div class="input-field">
								<input
									id="rut" name="rut" type="text" value="${param.rut}" readonly="readonly"> <label
									for="rut">RUT</label>
							</div>
							<button name="boton" value="modificar" type="submit" class="btn right green" >
								Modificar
							</button>
						</div>
    				</form>
